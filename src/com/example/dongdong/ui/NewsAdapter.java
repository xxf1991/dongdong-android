...
public class NewsAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		{	
		...
		else 
			{
			   ...
			   View view = LayoutInflater.from(mContext).inflate(R.layout.item_news_main, null);
	...
	private View getTopView(View convertView) {
		...
		if(mTopView==null){
		mTopView = LayoutInflater.from(mContext).inflate(R.layout.item_news_viewpager, null);

		RelativeLayout.LayoutParams  lp=new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT,300);

			lp.addRule(RelativeLayout.ALIGN_PARENT_TOP);
		 //lp.gravity = Gravity.TOP;
		// 页码指示点
		// 图片切换控件
		mNewsViewPager = (ViewPager) mTopView.findViewById(R.id.image_slide_page);
		mNewsViewPager.setLayoutParams(lp);
			 ...
			 leftImg = new ImageView(mContext);
				...
				leftImg.setImageResource(R.drawable.image01);
			...
			//	photoFront.setOnClickListener(new MyOnClickListener(0));
			    ...
			    rightImg.setImageResource(R.drawable.image02);
